...
public class Driver {
    ...
    public static boolean testPosFoodStation;
    ...
    private static void usage() {
        ...
        System.err.println("\t-p\tTest positions of food stations");
        System.exit(1);
    }
    ...
    public static void testRun(TownPlan problem) {
        ...
        if (testResponse) {
            ...
            problem.setPositionFoodStations(null);
            TownPlan responseTownPlan = program.OptimalResponse(problem);
            System.out.println(responseTownPlan);
        }

        if (testPosFoodStation) {
	        problem.setResponse(null);
	        problem.setPositionFoodStations(null);
            TownPlan PosFoodTownPlan = program.OptimalPosFoodStations(problem);
            System.out.println(PosFoodTownPlan);
        }
    }
}
